...
int main() {
    ...
    int box_capacity = 70;
    auto [i, j] = find_item_pair_for_exact_box_fit(weights, box_capacity);
    ...
    auto common = find_common_products_across_carts(carts);
    ...
    int points = 1200;
    std::cout << "Loyalty Tier: " << get_tier_for_customer_score(tiers, points) << "\n";
